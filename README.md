...
1. Explain what a token is used for.
   Tokens are used as a means to authenticate a user on a server, which will grant them some level of authorization to the server's services
2. What steps can you take in your web apps to keep your data secure?
   Protected Routes are a good example of basic level routing where you can gatekeep users depending on their token, which could verify their level of access.
3. Describe how web servers work.
   Web servers host and render websites remotely rather than on the client side
